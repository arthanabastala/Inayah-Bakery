...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-primary hover:bg-rose-600 text-white shadow-lg shadow-rose-500/30 focus:ring-rose-500",
    secondary: "bg-dark hover:bg-gray-700 text-white shadow-lg focus:ring-gray-800",
    outline: "border-2 border-primary text-primary hover:bg-rose-50 focus:ring-rose-500",
  };
